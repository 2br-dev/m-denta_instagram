...
define('SITE_NAME', 'M-Denta');
define('GZIP_COMPRESS', true);
define('CSRF_PROTECTION', true);
define('DEFAULT_LANGUAGE', 'ru');
define('SEARCH_VAR', 'q');
define('ADMIN_EMAIL', '92279@inbox.ru');
...
define('SEND_MAILER_SERVER', 'smtp.inbox.ru');
define('SEND_MAILER_EMAIL', '92279@inbox.ru');
define('SEND_MAILER_NAME', 'M-Denta');
define('SEND_MAILER_PASSWORD', '2212198638180067+Olga');
